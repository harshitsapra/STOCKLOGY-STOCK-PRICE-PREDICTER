...
#feature 1 - Home
if(feature =="Home"):
    st.markdown('# STOCKLOGY')
    st.markdown(" ### STOCKLOGY is the all in one financial website for the retail investors where retail investors can take a look at all Technical Indicators, Pattern Recognition and Next-Day Forecasting of all the National Stock Exchange (NSE) listed stocks.")
    st.markdown('#### Features we provide:')
    ...
    st.markdown('##### -  Webapp have features like Technical Indicators, Pattern Recognition, Next-Day Forecasting (Machine Learning based).')
    ...
    st.markdown('#### Fundamental Information feature overview (yfinance stopped support*):')
    ...
    st.markdown('#### Technical Screener feature overview(yfinance stopped support*):')
    ...
    st.markdown(' ##### -  We can say it is a star feature of STOCKLOGY.')
